...
/*function discardEditPropertyDetailsChanges(id){
    $.ajax({
        ...
        success: function (response) {
            ...
            let html2 = `<span class="bi bi-pen-fill pen-big" onclick="editSportDetails('${id}')"></span>`
...
/*function discardEditPropertyAddress(id){
    $.ajax({
        ...
        success: function (response) {
            ...
            let html2 = `<span class="bi bi-pen-fill pen-big" onclick="editSportAddress('${id}')"></span>`
...
/*function discardEditPropertyOwnerDetails(id){
    $.ajax({
        ...
        success: function (response) {
            ...
            let html2 = `<span class="bi bi-pen-fill pen-big" onclick="editSportOwnerDetails('${id}')"></span>`
...
function discardEditPropertyOwnerAddress(id){
    $.ajax({
        ...
        success: function (response) {
            ...
            let html2 = `<span class="bi bi-pen-fill pen-big" onclick="editSportOwnerAddress('${id}')"></span>`
...
function discardEditPropertyOwnerContactDetails(id){
    $.ajax({
        ...
        success: function (response) {
            ...
            let html2 = `<span class="bi bi-pen-fill pen-big" onclick="editSportOwnerContactDetails('${id}')"></span>`
