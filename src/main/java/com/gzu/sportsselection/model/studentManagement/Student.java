...
public class Student {
    ...
    public Student(String name, String surname, String email, String phone, String id_passport, String property, String rentStatus, List<Ground> groundObjectlist, List<Lease> leaseObjectlist) {
        this.name = name;
